...
Mental-health and social-stressor conversations on social media are now a **global challenge**. Across countries, people use platforms such as Reddit to disclose deeply personal struggles with **addiction, alcoholism, ADHD, bipolar disorder, depression, and divorce**. These posts are often written at crisis points: when someone is relapsing into substance use, overwhelmed by untreated ADHD, destabilised by bipolar mood swings, trapped in a depressive episode, or navigating the emotional and practical chaos of marital breakdown. Although these conversations contain rich signals about people’s mental health and support needs, they appear as an unstructured stream of millions of posts distributed across different communities. Human moderators, clinicians, and public-health practitioners cannot manually read or monitor this volume of content in real time.

Canada is not exempt from these pressures, and **Atlantic Canada** (Nova Scotia, New Brunswick, Prince Edward Island, Newfoundland and Labrador) experiences its own mix of economic stress, rural/urban disparities, and limited access to mental-health services. Even though the dataset used here is drawn from global Reddit communities, the **patterns of distress and coping behaviours it captures are highly relevant to Canadian and Atlantic Canadian populations**: substance use, mood instability, attention-related difficulties, and family breakdown appear in very similar forms across regions.
...
- Detect **emerging patterns of distress** in near real time (e.g. rising volumes of addiction- or depression-related posts) and compare them across regions and time periods.
- See **which types of problems are most prominent** globally while recognising that similar issue-mixes are present in Canada and Atlantic Canada.
- Inform **targeted outreach and resource allocation** (for example, whether to prioritise addiction services, depression interventions, ADHD supports, or family support programmes) in local health systems, using insights drawn from large-scale social media data as one additional evidence source.
